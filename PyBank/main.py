...
with open(csv_path, newline="") as csvfile:
    ...
    # max and min changes in P/L over the entire period
    max_change = max(profit_loss_changes)
    min_change = min(profit_loss_changes)

    # Locate the index value of highest and lowest changes in P/L over the entire period
    highest_month_index = profit_loss_changes.index(max_change)
    lowest_month_index = profit_loss_changes.index(min_change)
